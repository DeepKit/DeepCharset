...
- [x] 2024.03.29: 实现核心功能
- [x] 2024.06.10: 完成 TMemo 替代 SynEdit
- [x] 2024.07.14: 完成代码优化和性能改进
- [ ] 2024.07.20: 解决编译问题
- [ ] 2024.07.25: 添加用户体验改进
- [ ] 2024.08.01: 发布 beta 版本
...
### 2024-07-14：代码清理与优化
- [x] 清理项目目录，移除不必要的文件
- [x] 移除ViewMainCode中未使用的私有字段和方法
- [x] 重构日志记录机制，添加Log和LogFmt辅助方法
- [x] 修复匹名方法的类型不兼容问题

### 2024-07-14：性能改进
- [x] 实现批量转换的并行处理功能
- [x] 根据CPU核心数自动调整并发任务数
- [x] 添加编码检测缓存机制，避免重复检测同一文件
- [x] 优化内存使用，减少不必要的内存占用