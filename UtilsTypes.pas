...
const
  ...
  LANGUAGE_MAPPINGS: array[0..15] of TSimpleLanguageInfo = (
    ...
    (LanguageCode: 'ko-KR'; DisplayName: '???'),
    (LanguageCode: 'es-ES'; DisplayName: 'Espa?ol'),
    (LanguageCode: 'fr-FR'; DisplayName: 'Fran?ais'),
    ...
    (LanguageCode: 'ar-SA'; DisplayName: '???????'),
    (LanguageCode: 'nl-NL'; DisplayName: 'Nederlands'),
    (LanguageCode: 'th-TH'; DisplayName: '???'),
    (LanguageCode: 'vi-VN'; DisplayName: 'Ti?ng Vi?t'),
