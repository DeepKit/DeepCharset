...
const
  ...
  LANGUAGE_MAPPINGS: array[0..15] of TSimpleLanguageInfo = (
    ...
    (LanguageCode: 'ko-KR'; DisplayName: 'Korean'),
    (LanguageCode: 'es-ES'; DisplayName: 'Espanol'),
    (LanguageCode: 'fr-FR'; DisplayName: 'Francais'),
    (LanguageCode: 'de-DE'; DisplayName: 'Deutsch'),
    (LanguageCode: 'it-IT'; DisplayName: 'Italiano'),
    (LanguageCode: 'zh-TW'; DisplayName: '繁體中文'),
    (LanguageCode: 'ru-RU'; DisplayName: 'Russian'),
    (LanguageCode: 'pt-BR'; DisplayName: 'Portugues'),
    (LanguageCode: 'ar-SA'; DisplayName: 'Arabic'),
    (LanguageCode: 'nl-NL'; DisplayName: 'Nederlands'),
    (LanguageCode: 'th-TH'; DisplayName: 'Thai'),
    (LanguageCode: 'vi-VN'; DisplayName: 'Vietnamese'),
...
begin
  ...
  // 中文编码
          ...
          (UpperEncName = '936') or (UpperEncName = 'CP936') then
    Result := CP_GBK
  else if (UpperEncName = 'BIG5') or (UpperEncName = '950') or (UpperEncName = 'CP950') then
    Result := CP_BIG5
